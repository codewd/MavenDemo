					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form onsubmit="return onsub()" method="post" action="/ui/fileUp_add.htm" class="form-horizontal" role="form"  enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 选择文件 </label>

										<div class="col-sm-9">
											<input type="file" id="a"  class="col-xs-10 col-sm-5" name="file"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="radio" value='0' name="flag">私有 &nbsp;&nbsp;<input type="radio" name='flag' value='1'>共享
										</div>
									</div>
