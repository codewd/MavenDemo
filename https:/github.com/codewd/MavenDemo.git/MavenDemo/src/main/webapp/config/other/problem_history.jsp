...
<div class="breadcrumbs" id="breadcrumbs">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div><button class="btn btn-danger" onclick="bHref('/ui/problem_addUI.htm')">继续分配</button></div>
...
<![endif]-->
		...
		<script src="/ui/assets/js/jqGrid/jquery.jqGrid.min1.js"></script>
		...
		<script type="text/javascript">
			...
			[ 
				<s:iterator value="#list" var="l">
						{ids:"${id}",later:"${later}",account:"${l.account}",content:"${content}",fstanderd:"${fstanderd}",stime:"${stime}",ftime:"${ftime}",days:"0",
							submit:<s:if test="#l.flag == 0">s1</s:if><s:else>"<button onclick='bOncilck(${id})' >评价</button>"</s:else>
							,comment:"${comment}",
						},
				</s:iterator>
			];	
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:[' ',' ','发布人','接收人','内容','完成标准','开始时间','结束时间','顺延天数','工作状态','领导评价'],
					...
					colModel:[
						...
						{name:'later',index:'later',width:90, editable:true, editoptions:{size:"20",maxlength:"30"}},
						{name:'account',index:'account',width:90, editable:true,editoptions:{size:"20",maxlength:"30"}},
						{name:'content',index:'content',width:350, editable:false, sorttype:"text",unformat: pickDate},
						{name:'fstanderd',index:'fstanderd',width:180, editable:true, sorttype:"date",unformat: pickDate},
						{name:'stime',index:'stime', width:90,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'ftime',index:'ftime', width:90,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'days',index:'days', width:60,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'submit',index:'submit', width:150,editable: false,editoptions:{size:"20",maxlength:"30"}},
						{name:'comment',index:'comment', width:200,editable: false,editoptions:{size:"20",maxlength:"30"}},
						//{name:'price',index:'price', width:60, sorttype:"int", editable: true},
						//<!--{name:'sdate',index:'sdate',width:90, editable:true, sorttype:"date",unformat: pickDate},-->					
						//{name:'values',index:'values', width:70, editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						//<!--{name:'',index:'', width:90, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},-->
						//{name:'restid',index:'restid', width:60, sorttype:"int", editable: true},
					...
					editurl: $path_base+"ui/problem_jqgrid.action",//nothing is saved
					caption: "工作内容列表：",
