	...
	<head>
		...
		<style type="text/css">
			...
			body {
				...
				background-image: url("/ui/assets/images/login_bg.jpg");
			}
		</style>
		...
		<div class="main-container">
			<div class="main-content">
				<div class="row">
					<div class="col-sm-5">
<!--						<div class="center">-->
<!--							<img src="images/qiu.png" alt="check by diggzhang@gmail.com" class="img-responsive img-rounded roundleft">-->
<!--						</div>-->
					</div>
					<div class="col-sm-5 col-sm-offset-1 pull-right">
						<div class="login-container round">
							<div class="center">
								<h1>
									<i class="icon-leaf green"></i>
									<span class="red">Kamama-OA</span><br>
									<span class='red' style="margin-top: 20px;">办公系统</span>
<!--									<span class="white">Project X</span>-->
								</h1>
<!--								<h4 class="blue">hack more for life, code more for fun</h4>-->
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action='user_login.htm' name='form1' method="post">
												<fieldset>
													...
													<div class="clearfix">
														...
														<script>function sub11(){document.form1.submit()}</script>
											...
											<div class="social-or-login center">
												<span class="bigger-110">Kamama</span>
											</div>
