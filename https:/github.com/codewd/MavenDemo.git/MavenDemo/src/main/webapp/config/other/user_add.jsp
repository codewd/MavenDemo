			...
			<script type="text/javascript">
				...
				<div class="main-container-inner">
					...
					<div class="sidebar" id="sidebar">
						...
						<script type="text/javascript" src='${pageContext.request.contextPath}js/confLeft1.js'></script>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form onsubmit="return onsub()" method="post" action="/ui/user_add.htm" class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 工号 </label>

										<div class="col-sm-9">
											<input type="text" id="a" placeholder="" class="col-xs-10 col-sm-5" name="account"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="b" placeholder="" class="col-xs-10 col-sm-5" name="psd"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="b" placeholder="" class="col-xs-10 col-sm-5" name="name"/>
										</div>
									</div>

									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 花名</label>

										<div class="col-sm-9">
											<input type="text" id="b" placeholder="" class="col-xs-10 col-sm-5" name="nikeName"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="c" placeholder="" class="col-xs-10 col-sm-5" name="zw"/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 直接上级</label>

										<div class="col-sm-9">
											<select name="leader">
												<s:iterator value="#users">
													<option value="${user.account }">${user.account }(${name })</option>
												</s:iterator>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="part">
												<option value='1'>网络管理部</option>
												<option value='2'>市场策划部</option>
												<option value='3'>服务管理部</option>
												<option value='4'>咨询管理部</option>
												<option value='5'>业务推广部</option>
												<option value='6'>行政人事部</option>
												<option value='7'>财务管理部</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="d" placeholder="" class="col-xs-10 col-sm-5" name="phone"/>
										</div>
									</div>

									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 企业邮箱</label>

										<div class="col-sm-9">
											<input type="text" id="d" placeholder="" class="col-xs-10 col-sm-5" name="email"/>
										</div>
									</div>
