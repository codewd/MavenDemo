				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<center><h4><font>${msg }</font></h4></center>
								<form onsubmit="return onsub()" method="post" action="user_psdChange.htm" class="form-horizontal" role="form">
									<input type="hidden" name="id" value='${user.id }'>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 旧密码</label>
										<div class="col-sm-9">
											<input type="password" id="form-field-1"  class="col-xs-10 col-sm-5" name='oldPsd' id='odlPsd'/>
										</div></div><div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1" name='psd1' id='psd1'> 新密码</label>
										<div class="col-sm-9">
											<input type="password" id="form-field-1"  class="col-xs-10 col-sm-5"/>
										</div></div><div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1" >再次输入</label>
										<div class="col-sm-9">
											<input type="password" id="form-field-1"  class="col-xs-10 col-sm-5" name='psd' id='psd'/>
										</div></div><div class="space-4"></div>
